...
def parse_args():
    ...
    parser.add_argument("--model_dir", type=str, default='./speedy/model')
    ...
    parser.add_argument("--pretrain_news_encoder_path", type=str, default='./speedy/pretrain_news_encoder/epoch-1-226000.pt')
